...
class StripeApiHandler {
  ...
  Future<dynamic> retrievePaymentIntent(String publishableKey, String clientSecret) {
    final url = "$LIVE_API_PATH/payment_intents/$clientSecret";
  }

  Future<dynamic> confirmPaymentIntent(String publishableKey, String clientSecret) {}
